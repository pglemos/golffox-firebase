...
exports.driverFunctions = void 0;
...
exports.driverFunctions = {
    // Criar motorista
    createDriver: async (data, context) => {
        try {
    ...
    updateDriverStatus: async (data, context) => {
        try {
            // Verificar autenticação
            if (!context.auth) {
                throw new Error('Usuário não autenticado');
            ...
            const isOwnDriver = (driverData === null || driverData === void 0 ? void 0 : driverData.user_id) === context.auth.uid;
            ...
            await admin.firestore()
                ...
                details: {
                    old_status: driverData === null || driverData === void 0 ? void 0 : driverData.status,
    ...
    getDriverPerformance: async (data, context) => {
        try {
            // Verificar autenticação
            if (!context.auth) {
                throw new Error('Usuário não autenticado');
            ...
            const performanceHistory = performanceSnapshot.docs.map(doc => {
                const perf = doc.data();
                return Object.assign(Object.assign({ id: doc.id }, perf), { period: {
            ...
            const metrics = {
                ...
                average_rating: ratingCount > 0 ? ratingSum / ratingCount : (driverData === null || driverData === void 0 ? void 0 : driverData.rating) || 5.0,
            ...
            return {
                ...
                driver: {
                    id: data.driverId,
                    name: driverData === null || driverData === void 0 ? void 0 : driverData.name,
                    license_number: driverData === null || driverData === void 0 ? void 0 : driverData.license_number,
                    performance_score: driverData === null || driverData === void 0 ? void 0 : driverData.performance_score,
                    total_routes: driverData === null || driverData === void 0 ? void 0 : driverData.total_routes,
                    total_distance: driverData === null || driverData === void 0 ? void 0 : driverData.total_distance,
                    rating: driverData === null || driverData === void 0 ? void 0 : driverData.rating,
                },
                period: {
