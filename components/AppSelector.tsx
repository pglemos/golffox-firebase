...
const AppSelector: React.FC<AppSelectorProps> = ({ currentView, setCurrentView }) => {
  return (
    <div className="w-full bg-golffox-blue-dark text-white p-3 flex items-center justify-between shadow-lg z-10">
      <div className="flex items-center">
        {/* FIX: Use Base64 logo to prevent broken image icon. */}
        <img src={GOLFFOX_LOGO_BASE64} alt="Golffox Logo" className="h-8 mr-3" />
        <h1 className="text-xl font-bold">Protótipo Golffox</h1>
      </div>
